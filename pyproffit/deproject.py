...
class Deproject:
    ...
    def PlotDensity(self,outfile=None,xscale='kpc'):
        ...
        if xscale == 'both':
            ...
            ax2.set_xscale('log')
            ax2.tick_params(length=20, width=1, which='major', direction='in', right='on', top='on', pad=10)
            ax2.tick_params(length=10, width=1, which='minor', direction='in', right='on', top='on', pad=10)
