...
def plot_multi_methods(profs,deps,labels=None):
    ...
    for i in range(len(deps)):
        ...
        rkpc = profs[i].bins * kpcp
        erkpc = profs[i].ebins * kpcp
        plt.errorbar(rkpc, dep.dens, xerr=erkpc, yerr=[dep.dens-dep.dens_lo,dep.dens_hi-dep.dens], fmt='.', color='C%d'%i, elinewidth=2,
